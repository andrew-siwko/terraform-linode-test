...
output "machine_info-02" {
  value = {
    id     = linode_instance.asiwko-vm-02.id
    label  = linode_instance.asiwko-vm-02.label
    ipv4   = one(linode_instance.asiwko-vm-02.ipv4)
    ipv6   = linode_instance.asiwko-vm-02.ipv6
    region = linode_instance.asiwko-vm-02.region
  }
}